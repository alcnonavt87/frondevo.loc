...
$base_url="http://gi.loc";  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = '/frontend/web/p/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../../../../frontend/web/p/source/'; // relative path from filemanager folder to upload folder (with final /)
