...
Class Games extends Model
{
    ...
    public function getPageByIdAndLang($id,$lang) {
        $query = Yii::$app->db->createCommand('SELECT
			...
			, `gamesmainscreentitle`, `gamesmainscreentitle1`, `imagegamesbgbig`, `imagegamesbgbigTitle`, `imagegamesbgsmall`, `imagegamesbgsmallTitle`, `gamesadvtitle`, `worksexamplesgamestitle`/*get*/
        FROM
            `pages` `a`, `content` `b`
        WHERE
