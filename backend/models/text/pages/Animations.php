...
Class Animations extends Model
{
    ...
    public function getPageByIdAndLang($id,$lang) {
        $query = Yii::$app->db->createCommand('SELECT
			...
			, `animationssmainscreentitle`, `animationsmainscreentitle1`, `imageanimationsbgbig`, `imageanimationsbgbigTitle`, `imageanimationsbgsmall`, `imageanimationsbgsmallTitle`, `animationsadvtitle`, `worksexamplesanimationstitle`, `worksexamplesanimationstitle`/*get*/
        FROM
            `pages` `a`, `content` `b`
        WHERE
