...
Class Frontendout extends Model
{
    ...
    public function getPageByIdAndLang($id,$lang) {
        $query = Yii::$app->db->createCommand('SELECT
			...
			, `titlefrontout`, `titlemiddlefrontout`, `titlesmallfrontout`, `titlefrontout`, `titlemiddlefrontout`, `titlesmallfrontout`, `titlesmallfrontout2`, `imagefrontoutbgbig`, `imagefrontoutbgbigTitle`, `imagefrontoutbgsmall`, `imagefrontoutbgsmallTitle`, `frndoutsect2title`, `frndoutsect2data`, `frndoutsect3title`, `othervariantstitle`, `othervariants1title`, `othervariants1text`, `othervariants2title`, `othervariants2text`, `ourcompaniestitle`, `linkvideobgfrnout`, `garantiesbgword`, `garanties1title`, `garanties2title`, `frontendoutworkstitle`, `worksexamplesfrontendouttitle`/*get*/
        FROM
            `pages` `a`, `content` `b`
        WHERE
