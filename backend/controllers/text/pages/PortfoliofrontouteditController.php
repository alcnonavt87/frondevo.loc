...
use backend\models\text\pages\Portfoliofrontout;


/**
 * PortfoliofrontoutEdit controller
 */
class PortfoliofrontoutEditController extends \backend\controllers\AdminController {
    ...
    public function actionIndex()
    {
        ...
        if (!$isAjax) {
            ...
            $myTextPage = new Portfoliofrontout();
            ...
            if  (isset($page[0])) {
                ...
                if (is_file(Yii::$app->basePath.'/views/pages/PortfoliofrontoutPageEditView.php')) {
                    require Yii::$app->basePath.'/views/pages/PortfoliofrontoutPageEditView.php';
                }
