...
class Psd2html5updateController extends \backend\controllers\AdminController {
        ...
        if (!$isAjax)
        {
			...
			foreach ($_SESSION['images'] as $item) { //только что добавленные
				...
				if ($uploader[0] == 'uploader0') { // одно изображение
					...
					$fileNameGeneral = Yii::$app->params['pics']['pages']['path']."bigpsd2html5bg-".$fileName;
					$imgGeneralWidth = Yii::$app->params['pics']['pages']['sizes']['imagepsd2html5bgbig']['width'];
					$imgGeneralHeight = Yii::$app->params['pics']['pages']['sizes']['imagepsd2html5bgbig']['height'];

					$fileNameSmall = Yii::$app->params['pics']['pages']['path']."smallpsd2html5bg-".$fileName;
					$imgSmallWidth = Yii::$app->params['pics']['pages']['sizes']['imagepsd2html5bgsmall']['width'];
					$imgSmallHeight = Yii::$app->params['pics']['pages']['sizes']['imagepsd2html5bgsmall']['height'];

					if ($_SERVER['REMOTE_ADDR'] == '') {
						if ($uploader[1] == 'imagepsd2html5bgbig') {
						...
						} else if ($uploader[1] == 'imagepsd2html5bgsmall') {
