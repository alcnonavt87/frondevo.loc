...
use backend\models\text\pages\Outsourcing;


/**
 * OutsourcingEdit controller
 */
class OutsourcingEditController extends \backend\controllers\AdminController {
    ...
    public function actionIndex()
    {
        ...
        if (!$isAjax) {
            ...
            if  (isset($page[0])) {
                ...
                if (is_file(Yii::$app->basePath.'/views/pages/OutsourcingPageEditView.php')) {
                    require Yii::$app->basePath.'/views/pages/OutsourcingPageEditView.php';
                }
