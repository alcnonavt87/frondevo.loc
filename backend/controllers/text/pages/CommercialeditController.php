...
use backend\models\text\pages\Commercial;


/**
 * CommercialEdit controller
 */
class CommercialEditController extends \backend\controllers\AdminController {
    ...
    public function actionIndex()
    {
        ...
        if (!$isAjax) {
            ...
            if  (isset($page[0])) {
                ...
                if (is_file(Yii::$app->basePath.'/views/pages/CommercialPageEditView.php')) {
                    require Yii::$app->basePath.'/views/pages/CommercialPageEditView.php';
                }
