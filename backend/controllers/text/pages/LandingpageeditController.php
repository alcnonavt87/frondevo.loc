...
use backend\models\text\pages\Landingpage;


/**
 * LandingpageEdit controller
 */
class LandingpageEditController extends \backend\controllers\AdminController {
    ...
    public function actionIndex()
    {
        ...
        if (!$isAjax) {
            ...
            if  (isset($page[0])) {
                ...
                if (is_file(Yii::$app->basePath.'/views/pages/LandingpagePageEditView.php')) {
                    require Yii::$app->basePath.'/views/pages/LandingpagePageEditView.php';
                }
