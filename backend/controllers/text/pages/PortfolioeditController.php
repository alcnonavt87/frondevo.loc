...
use backend\models\text\pages\Portfolio;


/**
 * PortfolioEdit controller
 */
class PortfolioEditController extends \backend\controllers\AdminController {
    ...
    public function actionIndex()
    {
        ...
        if (!$isAjax) {
            ...
            if  (isset($page[0])) {
                ...
                if (is_file(Yii::$app->basePath.'/views/pages/PortfolioPageEditView.php')) {
                    require Yii::$app->basePath.'/views/pages/PortfolioPageEditView.php';
                }
