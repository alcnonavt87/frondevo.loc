...
/**
 * GamesEdit controller
 */
class GamesEditController extends \backend\controllers\AdminController {
    ...
    public function actionIndex()
    {
        ...
        if (!$isAjax) {
            ...
            if  (isset($page[0])) {
                ...
                if (is_file(Yii::$app->basePath.'/views/pages/GamesPageEditView.php')) {
                    require Yii::$app->basePath.'/views/pages/GamesPageEditView.php';
                }
