...
<!-- commonData --><fieldset class="catalog__section">
	...
	<div class="catalog__section-data">
		<!-- title -->'.$this->createTextArea(['id'=> 'title', 'text' => 'Заголовок', 'width' => '400x100', 'name' => 'content[title]', 'value' => $advantagepsdhmtl5Item['title'], 'attr' => '']).'<!-- /title -->
		<!-- paragraph -->'.$this->createTextArea(['id'=> 'paragraph', 'text' => 'Абзац', 'width' => '400x100', 'name' => 'content[paragraph]', 'value' => $advantagepsdhmtl5Item['paragraph'], 'attr' => '']).'<!-- /paragraph -->
