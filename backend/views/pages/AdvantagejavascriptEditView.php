...
<!-- commonData --><fieldset class="catalog__section">
	...
	<div class="catalog__section-data">
		<!-- title -->'.$this->createTextArea(['id'=> 'title', 'text' => 'Заголовок', 'width' => '400x100', 'name' => 'content[title]', 'value' => $advantagejavascriptItem['title'], 'attr' => '']).'<!-- /title -->
		<!-- paragraph -->'.$this->createTextArea(['id'=> 'paragraph', 'text' => 'Абзац', 'width' => '400x100', 'name' => 'content[paragraph]', 'value' => $advantagejavascriptItem['paragraph'], 'attr' => '']).'<!-- /paragraph -->
