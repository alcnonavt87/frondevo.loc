                ...
                <form id="form-application" action="email/commercial" method="post" autocomplete="on" data-ajax novalidate class="action-form">
                    ...
                    <div class="row">
                        ...
                        <div class="input-wrap">
                            <label for="input-name">название компании *</label>
                    ...
                    <div class="row">
                        ...
                        <!-- input wrap -->
                        <div class="input-wrap">
                            <label for="input-contact">контактное лицо *</label>
                        ...
                        <!-- input wrap -->
                        <div class="input-wrap">
                            <label for="input-phone">ваш номер телефона</label>
...
//
?>
template for page Commercial<br>
<?php echo $pH1; ?>