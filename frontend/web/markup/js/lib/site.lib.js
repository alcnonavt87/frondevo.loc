	...
	_initIndicators: function () {
		...
		if ( this.options.scrollbars ) {
			...
			if ( this.options.scrollY ) {
				var isSb = $(this.wrapper).find('.iScrollVerticalScrollbar').length;
				if (isSb) {
					sb = $(this.wrapper).find('.iScrollVerticalScrollbar').eq(0)[0];
				} else {
					sb = createDefaultScrollbar('v', interactive, this.options.scrollbars);
				}
				indicator = {
					el: sb,
			...
			if ( this.options.scrollX ) {
				var isSb = $(this.wrapper).find('.iScrollHorizontalScrollbar').length;
				if (isSb) {
					sb = $(this.wrapper).find('.iScrollHorizontalScrollbar').eq(0)[0];
				} else {
					sb = createDefaultScrollbar('h', interactive, this.options.scrollbars);
				}
				indicator = {
					el: sb,
					interactive: interactive,
